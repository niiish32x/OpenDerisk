"""ORM models for RBAC permission tables and user groups."""
...
AGENT_ACTIONS = ["read", "chat", "write", "admin"]
TOOL_ACTIONS = ["read", "execute", "manage", "admin"]
KNOWLEDGE_ACTIONS = ["read", "query", "write", "admin"]
MODEL_ACTIONS = ["read", "chat", "manage", "admin"]
