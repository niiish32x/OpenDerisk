...
class DataScientistAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "Edgar",
            category="agent",
            key="derisk_agent_expand_dashboard_assistant_agent_profile_name",
        ),
        role=DynConfig(
            "DataScientist",
            category="agent",
            key="derisk_agent_expand_dashboard_assistant_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            category="agent",
            key="derisk_agent_expand_dashboard_assistant_agent_profile_goal",
        ),
        constraints=DynConfig(
            ...
            category="agent",
            key="derisk_agent_expand_dashboard_assistant_agent_profile_constraints",
        ),
        desc=DynConfig(
            "Use database resources to conduct data analysis, analyze SQL, and provide "
            "recommended rendering methods.",
            category="agent",
            key="derisk_agent_expand_dashboard_assistant_agent_profile_desc",
        ),
    )
