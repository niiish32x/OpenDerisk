...
from derisk_ext.plugin.auth.rbac.service import PermissionDefinitionService, PermissionService
...
async def remove_role_permission(
    ...
    from derisk_ext.plugin.auth.rbac.models import RolePermissionEntity
